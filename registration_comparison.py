...
if __name__ == '__main__':
	...
	bundle_list = ['cstL', 'cstR', 'ifofL', 'ifofR', 'thprefL', 'thprefR', 'ufL', 'ufR']]#['cbL', 'cbR', 'cstL', 'cstR', 'ifofL', 'ifofR', 'thprefL', 'thprefR', 'ufL', 'ufR']
	...
	np.save('DSC_nn_90', DSC_nn)
	np.save('DSC_rlap_90', DSC_rlap)
	...
	ax.set_title('Registration comparison with NN (90 pairs)')
	...
	ax.set_title('Registration comparison with RLAP (90 pairs)')
	ax.set_xticks(ind + 3*width / 2)
	ax.set_xticklabels(bundle_list)
