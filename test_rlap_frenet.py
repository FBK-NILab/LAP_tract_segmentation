...
def RLAP_modified(distance_matrix, frenet_matrix, superset, h):
    """Code for MODIFIED Rectangular Linear Assignment Problem.
    """
    print("Computing cost matrix.")
    cost_matrix = h * distance_matrix + (1-h) * frenet_matrix
...
if __name__ == '__main__':
	...
	registration = ['ant4fa']#['slr']#'ant4t1w', 'ant4fa']
	...
	np.save('DSC_rlap_frenet_3', DSC_rlap_frenet)
